(function(a) {
    a.fn.camera = function(H, V) {
        ...
        function Q(u) {
            for (var w, h, ap = u.length; ap; w = parseInt(Math.random() * ap), h = u[--ap], 
            u[ap] = u[w], u[w] = h) {}
            return u;
        }
        function x(h) {
                ...
                a.each(ay, function(a3, a5) {
                    ...
                    switch (aB) {
                      ...
                      case "stampede":
                        height = 0;
                        width = 0;
                        marginLeft = Z * .2 * (a3 % av - (av - Math.floor(av / 2))) + "px";
                        marginTop = aj * .2 * (Math.floor(a3 / av) + 1 - (a0 - Math.floor(a0 / 2))) + "px";
                        break;
                      ...
                      case "mosaicRandom":
                        height = 0;
                        width = 0;
                        marginLeft = Math.floor(Z / av + aE + 1) * .5 + "px";
                        marginTop = Math.floor(aj / a0 + aM + 1) * .5 + "px";
                        break;
                            ...
                            if (bb != 0) {
                                a(".cameraSlide.cameracurrent .fadeIn", D).each(function() {
                                    ...
                                    if (bi.indexOf("fadeIn") != -1) {
                                        bn.animate({
                                            opacity: 0
                                        }, 0).css("visibility", "visible").delay(aX / bb * (.1 * (bd - 1))).animate({
                                            opacity: 1
                                        }, aX / bb * .15, bh);
                                    } else {
                            ...
                            if (a8 != 0) {
                                a(".cameraContent.cameracurrent .moveFromLeft, .cameraContent.cameracurrent .moveFromRight, .cameraContent.cameracurrent .moveFromTop, .cameraContent.cameracurrent .moveFromBottom, .cameraContent.cameracurrent .fadeIn, .cameraContent.cameracurrent .fadeFromLeft, .cameraContent.cameracurrent .fadeFromRight, .cameraContent.cameracurrent .fadeFromTop, .cameraContent.cameracurrent .fadeFromBottom", D).each(function() {
                                    ...
                                    if (bj.indexOf("moveFromLeft") != -1) {
                                        ...
                                        bf.css("visibility", "visible").delay(aX / a8 * (.1 * (bg - 1))).animate({
                                            left: bk.left
                                        }, aX / a8 * .15, be);
                                    } else {
                                                            ...
                                                            if (bj.indexOf("fadeFromTop") != -1) {
                                                                ...
                                                                if (bj.indexOf("fadeFromBottom") != -1) {
                                                                    ...
                                                                    if (bj.indexOf("fadeIn") != -1) {
                                                                        bf.animate({
                                                                            opacity: 0
                                                                        }, 0).css("visibility", "visible").delay(aX / a8 * (.1 * (bg - 1))).animate({
                                                                            opacity: 1
                                                                        }, aX / a8 * .15, be);
                                                                    } else {
                    ...
                    if (aB == "scrollLeft" || aB == "scrollRight" || aB == "scrollTop" || aB == "scrollBottom" || aB == "scrollHorz") {
                        ...
                        a7 = 0;
                        a6.delay((aI + h) / a2 * aO[a3] * aW * .5).css({
                            display: "block",
                            height: height,
                        ...
                        i.eq(aZ).delay((aI + h) / a2 * aO[a3] * aW * .5).animate({
